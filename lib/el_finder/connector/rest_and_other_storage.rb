...
module ElFinder
  ...
  module Connector
    ...
    # Represents ElFinder connector to REST service and other connector.
    class RestAndOtherStorage < AbstractConnector
      ...
      def initialize(options)
        ...
        @one_connector = ElFinder::Connector::ConnectorFactory.createConnector('rest').new(@options)
